...
class ZeroShotImageNetEvaluator(Evaluator):
    ...
    def __init__(self, tokenizer, device):
        ...
        # [TODO]: https://github.com/ykojima4020/mae_clip/issues/21
        # transforms = get_original_vit_image_encoder_transforms('valid')
        transforms = get_open_clip_vitb16_transforms('valid')
    ...
    def _zeroshot_classifier(self, model, classnames, templates):
        with torch.no_grad():
            ...
            for classname in tqdm(classnames):
                ...
                texts = self._tokenizer(texts).to(self._device)
                ...
                class_embeddings = model.text_encode(texts) #embed with text encoder
